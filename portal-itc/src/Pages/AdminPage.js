...
const SuperAdminDashboard = () => {
  const [currentSection, setCurrentSection] = useState('Payment Verification');
  ...
  const CurrentComponent = sections[currentSection]?.component || registration[currentSection]?.component;
            ...
            <div className="mb-2">
              ...
              >
                <div className="flex items-center space-x-3">
                  <FaFileAlt />
                  <span className="text-sm font-medium">Registration Manager</span>
                </div>
              ...
              {isTimetableOpen && (
                <div className="ml-6 mt-1 space-y-1">
                  {Object.keys(registration).map((section) => {
                    const Icon = registration[section].icon;
                    return (
                      <button
                        key={section}
                        onClick={() => {
