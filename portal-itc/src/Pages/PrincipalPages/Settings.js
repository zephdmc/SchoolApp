...
const Logout = () => {
  ...
  return (
    <div className="p-6 w-full mx-auto bg-white shadow-lg rounded-lg mt-10">
    <h2 className="text-2xl font-bold mb-4 text-left">Do you want to logout</h2>
      <button
        onClick={handleLogout}
        className="px-4 py-2 bg-itccolor text-white item-center rounded-md shadow-lg hover:bg-orange-600"
      >
